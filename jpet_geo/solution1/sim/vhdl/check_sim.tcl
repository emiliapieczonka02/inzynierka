...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.GetLocation.autotvin_tdc_channel.dat"
         "c.GetLocation.autotvout_agg_result_x.dat"
         "c.GetLocation.autotvout_agg_result_y.dat"
         "c.GetLocation.autotvout_agg_result_module.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.GetLocation.autotvout_agg_result_x.dat"
         "rtl.GetLocation.autotvout_agg_result_y.dat"
         "rtl.GetLocation.autotvout_agg_result_module.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
