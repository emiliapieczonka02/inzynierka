...
if {[file isfile GetLocation.autotvin.dat]} {
	file delete -force GetLocation.autotvin.dat
}

if {[file isfile GetLocation.autotvout.dat]} {
	file delete -force GetLocation.autotvout.dat
}
