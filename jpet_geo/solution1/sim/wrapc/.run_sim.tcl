...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "GetLocation.autotvin.dat"
	set constFileTvOut       "GetLocation.autotvout.dat"
	set constFileHdlTvIn     "GetLocation.autohdltvin.dat"
	set constFileHdlTvOut    "GetLocation.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
