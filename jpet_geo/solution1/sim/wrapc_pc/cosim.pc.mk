...
$(ObjDir)/jpet_geo_tb.cpp_pre.cpp.tb.o : jpet_geo_tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling jpet_geo_tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) gcc -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \

$(ObjDir)/jpet_geo.cpp_pre.cpp.tb.o : jpet_geo.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling jpet_geo.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) gcc -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \
